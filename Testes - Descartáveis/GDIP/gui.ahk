/*
	* * * Compile_AHK SETTINGS BEGIN * * *
	[AHK2EXE]
		Exe_File=C:\users\dsantos\desktop\executáveis\gui.exe
		Created_Date=1
	[VERSION]
		Set_Version_Info=1
...
;	Code
	...
	pBitmap	:= Gdip_CreateBitmapFromFile("background.png")	; Get a bitmap from the image
	...
	; So this will position our gui at (0,0) with the Width and Height specified earlier (half of the original image)
		UpdateLayeredWindow(hwnd1, hdc, A_ScreenWidth/2-Width/2, A_ScreenHeight/2-Height/2, Width//2, Height//2)
