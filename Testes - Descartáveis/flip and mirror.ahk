...
Loop, 29 {
	ip++
	OutputDebug % ip
	url = http://admin:tq8hSKWzy5A@10.2.78.%ip%/cgi-bin/configManager.cgi?action=setConfig&VideoImageControl[0].Flip=false&VideoImageControl[0].Mirror=false
	OutputDebug % http( url,, 1 )
}
ExitApp
;
